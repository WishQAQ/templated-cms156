...
?>
<div class="userinfo">
    <div class="welcome">你好：<strong><a href="<?php echo $cfg_memberurl; ?>/index.php">[ <?php echo $cfg_ml->M_UserName; ?> ]</a></strong><a href="<?php echo $cfg_memberurl; ?>/article_add.php">发表文章</a><a href="<?php echo $cfg_memberurl; ?>/index_do.php?fmdo=login&dopost=exit">退出登录</a></div>
    <!--<div class="userface">
        <a href="<?php echo $cfg_memberurl; ?>/index.php"><img src="<?php echo $facepic;?>" width="52" height="52" /></a>
    </div>-->
    <!--<div class="mylink" style="float:left">
        <ul>
    ...
    -->
    <!--<div class="uclink" style="float:left">
